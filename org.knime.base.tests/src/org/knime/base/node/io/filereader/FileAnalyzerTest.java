...
public class FileAnalyzerTest extends TestCase {
    ...
    private static final String TEMP_FILE_CONTENT_PART_1 = "foo,poo,moo,zoo\n";

    private static final String TEMP_FILE_CONTENT_PART_2 = "oof,oop,oom,ooz";

    private static final String TEMP_FILE_CONTENT_PART_3 = "row1,poo,moo,zoo\n";

    private static final String TEMP_FILE_CONTENT_PART_4 = ",col0,col1,col2\n";

    private static final NodeLogger LOGGER =
            NodeLogger.getLogger(FileAnalyzerTest.class);
    ...
    public void testColHeader() {
        ...
        try {
             ...
             */
            path = initTempFile("column1,column2,column3,column4\n"
                    + TEMP_FILE_CONTENT_PART_1 + TEMP_FILE_CONTENT_PART_2);
            try {
                settings = new FileReaderNodeSettings();
                settings.setDataFileLocationAndUpdateTableName(path.toUri().toURL());
             ...
             */
            path = initTempFile("col1,col2,foo3,col4\n" + TEMP_FILE_CONTENT_PART_1 + TEMP_FILE_CONTENT_PART_2);
            try {
                settings = new FileReaderNodeSettings();
                settings.setDataFileLocationAndUpdateTableName(path.toUri().toURL());
                analSettings = FileAnalyzer.analyze(settings, null);
             ...
             * different prefixes: no headers
             */
            path = initTempFile("col1,2,foo3,4\n" + TEMP_FILE_CONTENT_PART_1 + TEMP_FILE_CONTENT_PART_2);
            try {
                settings = new FileReaderNodeSettings();
                settings.setDataFileLocationAndUpdateTableName(path.toUri().toURL());
                analSettings = FileAnalyzer.analyze(settings, null);
             ...
             */
            path = initTempFile("col1,,col3,col4\n" + TEMP_FILE_CONTENT_PART_1 + TEMP_FILE_CONTENT_PART_2);
            try {
                settings = new FileReaderNodeSettings();
                settings.setDataFileLocationAndUpdateTableName(path.toUri().toURL());
                analSettings = FileAnalyzer.analyze(settings, null);
             ...
             */
            path = initTempFile("col9999999999999999999999999999999999999999999,"
    ...
    public void testQuote() {
        ...
        try {
             ...
             * nice quoting
             */
            path = initTempFile("\"col1\",'col2',col3,col4\n"
                    + "\"foo\",poo,\"moo\",zoo\n" + "oof,'oo p',oom,' ooz '");
            ...
            assertTrue(analSettings.getFileHasColumnHeaders());
            assertEquals(analSettings.getNumberOfColumns(), 4);
            ArrayList<Quote> quotes = new ArrayList<>(analSettings.getAllQuotes());
            ...
            try {
                ...
                assertTrue(analSettings.getFileHasColumnHeaders());
                assertEquals(analSettings.getNumberOfColumns(), 4);
                quotes = new ArrayList<>(analSettings.getAllQuotes());
                // we support '"' still
    ...
    public void testRowHeader() {
        ...
        try {
             ...
             */
            path = initTempFile("\"\",col0,col1,col2\n" + TEMP_FILE_CONTENT_PART_3
                    + "row2,oop,oom,ooz");
            try {
                settings = new FileReaderNodeSettings();
                settings.setDataFileLocationAndUpdateTableName(path.toUri().toURL());
             ...
             */
            path = initTempFile(TEMP_FILE_CONTENT_PART_4 + TEMP_FILE_CONTENT_PART_3
                    + "row2,poo,moo,zoo\n" + "row3,poo,moo,zoo\n"
                    + "row4,oop,oom,ooz");
            try {
                settings = new FileReaderNodeSettings();
    ...
    public void testHeaderHelperClass3() {
        ...
        assertEquals(HeaderHelper.extractPrefixAndIndexFromHeader("Foo17Oops"), null);
    }
     ...
     */
    private static Path initTempFile(final String contents) throws IOException {
     ...
     *
     * @throws IOException if the file be instantiated or written or if there was an error reading from the URL
     */
    public void testDatesWithThousandSeparator() throws IOException{
        Path path = initTempFile("1.000,5;24.05.2015\n1.000,5;24.05.2015\n");
        try {
     ...
     * @throws IOException if the file be instantiated or written or if there was an error reading from the URL
     */
    public void testNumbersWithThousandseparator() throws IOException {
        String withThousandSeparator = "1\n-1\n1\n1,123,456\n-1,123,456\n+1,123,456\n" +
                ...
                "1,123,456.05e-2f\n-1,123,456.05e2f\n1,123,456.05e+2f" +
                "1,123,456.05e-2d\n-1,123,456.05e2d\n1,123,456.05e+2d";
        Path path = initTempFile(withThousandSeparator);
        try {
            FileReaderNodeSettings settings = new FileReaderNodeSettings();
            settings.setFileHasRowHeadersUserSet(true);
            settings.setFileHasRowHeaders(false);
