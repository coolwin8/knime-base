...
final class MyPair implements AutoCloseable {
    ...
    MyPair(final FSPathProviderFactory pathProvFactory, final FSLocation fsLocation, final FSPath destinationPath,
        final PathRelativizer pathRelativizer) {
        m_myEntry = new MyEntry(pathProvFactory, fsLocation);
        m_destinationPath = destinationPath;
        m_pathRelativizer = pathRelativizer;
    }
