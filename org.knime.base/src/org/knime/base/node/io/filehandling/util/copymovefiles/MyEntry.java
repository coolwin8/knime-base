 ...
 */
final class MyEntry implements AutoCloseable {

    private final FSPathProvider m_pathProvider;

    MyEntry(final FSPathProviderFactory pathProvFactory, final FSLocation fsLocation) {
